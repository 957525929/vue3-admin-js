      ...
      <a-tree :tree-data="data.tree_data" :defaultExpandAll="true">
        <template #title="{ key: treeKey, title }">
          <div class="menu-item">
            <span>{{title}}</span>
            <div class="button-group">
              <a-button type="primary" class="button-mini" @click="handlerCategory('child_category_add')">添加子菜单</a-button>
      ...
      <div class="form-wrap">
        <a-form ref="formDom" @finish="handleFinish" :model="field" :rules="rules_form" :label-col="labelCol" :wrapper-col="wrapperCol">
          ...
          <a-form-item :wrapper-col="{span:14,offset:8}">
            <a-button html-Type="submit" type="primary" :disabled="!data.menu_type" :loading="data.submit_loading">确认添加</a-button>
